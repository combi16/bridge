/// The core methods for a rebase fungible token. Extension standards may be
    ...
    ($contract: ident, $token: ident $(, $on_tokens_burned_fn:ident)?) => {
        ...
        impl FungibleTokenCore for $contract {
            ...
            fn ft_transfer(
                ...
                self.ft_transfer(receiver_id, amount.into(), memo)
            }
            ...
            fn ft_transfer_call(
                ...
                self.ft_transfer_call(receiver_id, amount, memo, msg)
            }
